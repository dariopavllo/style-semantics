"""
Adapted from: https://github.com/NVlabs/SPADE/blob/c0d50e6c4c106c0e88974f445f435b8ba5f4ccf6/options/train_options.py
"""
...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--benchmark', action='store_true', help='enable CuDNN benchmark mode for faster training')
